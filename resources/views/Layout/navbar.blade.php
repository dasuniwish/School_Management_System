<nav class="navbar" style="background-color: #001a33;">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="{{ route('dashboard') }}"><i class="bi bi-building"></i>&nbsp;School Management System</a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="background-color: #001a33; color: white; width: 350px;">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item mb-2">
            <a class="nav-link text-white" href="{{ route('roles.index') }}"><i class="bi bi-person-fill-add"></i>&nbsp;Assign Role</a>
          </li>
